  ...
  <body class="text-center">
    <div class="form-register">
      <form onsubmit="return false">
        ...
        <h1 class="mt-3 mb-3 text-primary">สมัครสมาชิกผู้จัดงาน</h1>
        ...
        <div class="row mb-3">
          <div class="col">
            <button type="button" onclick="organizer_create()" class="btn btn-primary w-100 mt-3">
              สมัคร
            </button>
          </div>
          <div class="col">
        ...
        <div class="row">
          <p>นโยบายความเป็นส่วนตัวของผู้จัดงาน</p>
        </div>
      </form>
    </div>
